...
The `verify-readme-opcodes` workflow validates the autogenerated table below on every PR and merge to `master`. Regenerate it with `go run ./cmd/readme-sync --write`.
